...
import StatisticheCoworking from '../../components/StatisticheCoworking.jsx'
...
export default function Dashboard() {
  ...
  return (
    <div>
      ...
      {/* SEZIONE STATISTICHE — analytics aggregate per periodo configurabile */}
      <StatisticheCoworking />
    </div>
  )
}
